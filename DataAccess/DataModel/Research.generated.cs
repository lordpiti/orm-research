...
namespace DataModels
{
	...
	/// Server Version : 11.2
	/// </summary>
	public partial class ResearchDB : LinqToDB.Data.DataConnection
	{
		public ITable<test_Category> Categories { get { return this.GetTable<test_Category>(); } }
		public ITable<test_Product>  Products   { get { return this.GetTable<test_Product>(); } }
		...
		public ResearchDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public partial class test_Category
	{
		[Column("id"),   PrimaryKey, Identity] public int    Id   { get; set; } // integer
		[Column("name"), Nullable            ] public string Name { get; set; } // character varying

		#region Associations

		/// <summary>
		/// category_fk_BackReference
		/// </summary>
		[Association(ThisKey="Id", OtherKey="CategoryId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<test_Product> Categoryfks { get; set; }
	...
	public partial class test_Product
	{
		...
		[Column("categoryId"), Nullable            ] public int?   CategoryId { get; set; } // integer
		...
		/// category_fk
		/// </summary>
		[Association(ThisKey="CategoryId", OtherKey="Id", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="category_fk", BackReferenceName="Categoryfks")]
	...
	{
		public static test_Category Find(this ITable<test_Category> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}

		public static test_Product Find(this ITable<test_Product> table, int Id)
		{
			return table.FirstOrDefault(t =>
				t.Id == Id);
		}
